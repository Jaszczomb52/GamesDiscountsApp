...
namespace GamesDiscounts
{
    public partial class MainWindow : Form
    {
        ...
        private async void MainWindow_Load(object sender, EventArgs e)
        {
            ...
            await LoadPanels(manager.converted,Page.None);
        }
        ...
        private async Task LoadPanels(List<IGameGiveawayConvertedModel> models, Page page)
        {
            EnableLoading();
        ...
        private async void button1_Click_1(object sender, EventArgs e)
        {
            ...
            await LoadPanels(output,Page.None);
        ...
        {
            await LoadFromAPI();
            await LoadPanels(manager.converted,Page.First);
        }
        ...
        {
            await LoadPanels(manager.converted, Page.Right);
        ...
        {
            await LoadPanels(manager.converted, Page.Left);
